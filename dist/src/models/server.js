...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Boolean)
], Server.prototype, "error", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_1.User, user => user.server),
    (0, typeorm_1.JoinColumn)({ name: 'server-name' }),
    __metadata("design:type", user_1.User)
], Server.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Server.prototype, "email", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Server.prototype, "homeDir", void 0);
Server = __decorate([
    (0, typeorm_1.Entity)()
], Server);
